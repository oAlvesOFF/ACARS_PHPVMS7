...
pub enum FieldId {
    ...
    /// aggregiert: aus ASA-ACARS-Sicht ist Replay "Flug-Telemetrie
...
pub const CATALOG: &[DatarefEntry] = &[
    ...
    DatarefEntry {
        ...
        // 2026-05-05: pilot at FL390 mit OAT −46 °C sah ASA-ACARS
    ...
    DatarefEntry {
        ...
        // pilot landed mit ca. -350 fpm aber ASA-ACARS scorte
    ...
    // an ASA-ACARS gemeldet (siehe FieldId::SimPaused / SimInReplay).
...
pub struct XPlaneState {
    ...
    /// daraus gespeist.
    pub sim_paused: bool,
    /// Spec v0.7.15 F6: `sim/time/is_in_replay`-Wert. ASA-ACARS
