//! Forensik: gzip + POST des per-Flug JSONL-Logfiles an asa-acars-live
...
/// gegen denselben asa-acars-live Host gehen.
fn default_upload_url() -> String {
    DEFAULT_PROVISION_URL.replace("/api/provision", "/api/flight-logs/upload")
}

/// Lade JSONL-Datei, komprimiere mit gzip, POSTe an asa-acars-live.
///
/// Args:
