...
export interface ActiveFlightInfo {
  ...
  // den PIREP blind zu filen. Spec §ASA-ACARS Client Tab "Landung"
 ...
 *  `Resources/plugins/ASA-ACARS/` folder, `active` flips to true
