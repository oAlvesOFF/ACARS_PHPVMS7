...
// Consent: localStorage `asa-acars.errorReporting.enabled` ("true"|"false")
...
export const STORAGE_KEY = "asa-acars.errorReporting.enabled";
...
export function initSentry(appVersion: string): boolean {
  ...
  Sentry.init({
    dsn,
    release: `asa-acars-client@${appVersion}`,
